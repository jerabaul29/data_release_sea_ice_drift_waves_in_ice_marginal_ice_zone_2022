...
input_file = "./data_waves_Antarctic_Casey_2020_10.nc"
...
for crrt_index, crrt_logger_ID in enumerate(list_keys_ordered_by_first_lat):
    ...
    pclr = plt.pcolor(crrt_datetimes_holed[1:], frequencies, np.transpose(crrt_spectra_logged_holed)[:, 1:], vmin=-7.0, vmax=-2.0)
