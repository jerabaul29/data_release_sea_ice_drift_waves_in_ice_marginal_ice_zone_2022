...
output_file = "data_drift_waves_Barents_2018_09.nc"
...
with nc4.Dataset(output_file, "w", format="NETCDF4") as nc4_out:
    ...
    nc4_out.title = "Sea ice drift and wave measurements from the Arven Etter Nansen Physical Process Cruise 2018"

    nc4_out.summary = \
        "The sea ice drifter trajectories and wave measurements from the Arven Etter Nansen Physical Cruise 2018. The " +\
        "trajectories and wave measurements were obtained by instruments deployed on the ice. For more information " +\
        "about the deployment, see: Fer, Ilker, et al. Physical Process Cruise 2018. The Nansen Legacy Report Series 2 " +\
        "2020. The data are created, stored, and quality checked using the code available at: " +\
        "https://github.com/jerabaul29/data_release_sea_ice_drift_waves_in_ice_marginal_ice_zone_2022/tree/master/Data/2018_September_Barents/Instruments_V_2018 . " +\
    ...
    nc4_out.references = "https://doi.org/10.7557/nlrs.5503 "
