...
output_file = "data_Spotter_Antarctic_Davis_2020_01.nc"
...
with nc4.Dataset(output_file, "w", format="NETCDF4") as nc4_out:
    ...
    nc4_out.title = "Spotter measurements in sea ice close to the Davis Antarctic station october 2020"

    nc4_out.summary = \
        "Waves in ice data obtained outside of the Davis station from the Australian Antarctic Program, projects 4593 and 4506. The " +\
        "wave measurements were obtained by Sofar Spotter instruments deployed on the ice. For more information " +\
        "about the deployment, see: Voermans, Joey J., et al. 'Experimental evidence for a universal threshold characterizing wave-induced sea ice break-up.' " +\
        "The Cryosphere 14.11 (2020): 4265-4278.. " +\
        "Data are reproduced here, but primary hosting is taking place at https://data.aad.gov.au/metadata/records/AAS_4593_WB_IB_2020_all_data . " +\
        "The data presented here are created, stored, and quality checked using the code available at: " +\
        "https://github.com/jerabaul29/data_release_sea_ice_drift_waves_in_ice_marginal_ice_zone_2022/tree/master/Data/2020_January_Antarctic_Davis . " +\
    ...
    nc4_out.date_created = "2021-10-15T12:00:00:Z"
    ...
    nc4_out.project = "Australian Antarctic Program, projects 4593 and 4506; Joyce Lambert Antarctic Research Fund (grant no. 604086); " +\
        "the Research Council of Norway (SFI SIB grant and Petromaks II DOFI project, grant no. 280625) "

    nc4_out.instrument = "GNSS, differential GPS, waves in ice"

    nc4_out.references = "Voermans, Joey J., et al. 'Experimental evidence for a universal threshold characterizing wave-induced sea ice break-up"
