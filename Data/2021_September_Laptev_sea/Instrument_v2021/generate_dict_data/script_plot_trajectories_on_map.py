...
proj = ccrs.LambertConformal(central_latitude=81.8,
                             central_longitude=121.0,
                             standard_parallels=(80, 82.5))
...
ax.set_extent([100, 130, 76.0, 84.5])
...
for ind, crrt_instrument in enumerate(dict_data_each_logger.keys()):
    ...
    nbr_times = 5
    first_time = datetime.datetime(2021, 9, 16, 0, 0, 0)
    last_time = datetime.datetime(2021, 9, 30, 0, 0, 0)
...
plt.savefig("all_trajectories_Laptev_instrumentsv2021.png")
plt.savefig("all_trajectories_Laptev_instrumentsv2021.pdf")
