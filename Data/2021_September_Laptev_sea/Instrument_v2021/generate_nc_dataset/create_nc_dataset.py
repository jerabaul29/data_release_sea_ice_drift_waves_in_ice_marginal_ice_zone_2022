...
list_instruments_use_spectra = ["Zeni-v2021",
                                ]
...
list_frequencies = all_data["Zeni-v2021"]["spectra"][0].list_frequencies
nbr_of_frequency_bins = len(list_frequencies)

# ------------------------------------------------------------------------------------------
print("***** prepare the dataset")

output_file = "data_drift_waves_Laptev_2021.nc"
...
with nc4.Dataset(output_file, "w", format="NETCDF4") as nc4_out:
    ...
    nc4_out.title = "Sea ice drift and wave measurements from the NABOS Laptev sea cruise, 2021"
    ...
    nc4_out.summary = \
        ...
        "Trajectories and wave measurements in this file were obtained by instruments OpenMetBuoy v2021-a deployed on the ice. For more information " +\
        ...
        "https://github.com/jerabaul29/data_release_sea_ice_drift_waves_in_ice_marginal_ice_zone_2022/tree/master/Data/2021_September_Laptev_sea/Instrument_v2021 . " +\
    ...
    nc4_out.date_created = "2022-08-24:00:00:Z"
    nc4_out.creator_type = "person"
    nc4_out.creator_institution = "Norwegian Meteorological Institute (MET), using data from the University of Tokyo"
    nc4_out.creator_name = "Jean Rabault, using data from Takehiko Nose"
    nc4_out.creator_email = "jeanr@met.no"
    nc4_out.creator_url = "https://orcid.org/0000-0002-7244-6592"
    nc4_out.institution = "Norwegian Meteorological Institute (MET), using data from the University of Tokyo"
    ...
    nc4_out.references = "XX: paper about cruise: not published yet "
