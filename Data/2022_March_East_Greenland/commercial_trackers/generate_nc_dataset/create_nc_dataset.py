...
with open("../generate_dict_data/data_from_Martin_2022.pkl", "br") as fh:
...
output_file = "data_drift_2022.nc"
...
with nc4.Dataset(output_file, "w", format="NETCDF4") as nc4_out:
    ...
    nc4_out.title = "Sea ice drift from the March 2022 deployment East of Greenland."

    nc4_out.summary = \
        "The sea ice drifter trajectories from the 2022 deployment East of Greenland, performed by Biuw et. al., " +\
        "in the context of the seals pup production study 2022, generated with the code at: " +\
        "https://github.com/jerabaul29/data_release_sea_ice_drift_waves_in_ice_marginal_ice_zone_2022/tree/master/Data/2022_March_East_Greenland/commercial_trackers . " +\
    ...
    nc4_out.project = "Survey to assess harp and hooded seal pup production in the Greenland sea pack-ice in 2022, Havforskningsinstituttet"

    nc4_out.instrument = "GNSS"

    nc4_out.references = "Report From Surveys To Assess Harp And Hooded Seal Pup Production In The Greenland Sea Pack-Ice In 2022 " +\
        "Biuw et. al.,  ISSN: 1503-6294 Published: 07.06.2022 Cruise no.: 2022703 Project No.: 14391"
