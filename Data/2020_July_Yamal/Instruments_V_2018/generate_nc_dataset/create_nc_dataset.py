...
output_file = "data_drift_waves_Yamal_2020_07.nc"
...
with nc4.Dataset(output_file, "w", format="NETCDF4") as nc4_out:
    ...
    nc4_out.title = "Sea ice drift and wave measurements from the Fram 2020 expedition"

    nc4_out.summary = \
        "The sea ice drifter trajectories and wave measurements from the Fram 2020 expedition. The " +\
        "trajectories and wave measurements were obtained by instruments deployed on the ice. For more information " +\
        "about the deployment, see: 'Fram 2020 Final report', Tor Arne Johansen and Yngve Kristoffersen, 2020. " +\
        "The data are created, stored, and quality checked using the code available at: " +\
        "https://github.com/jerabaul29/data_release_sea_ice_drift_waves_in_ice_marginal_ice_zone_2022/tree/master/Data/2020_July_Yamal . " +\
    ...
    nc4_out.date_created = "2021-09-08T12:00:00:Z"
    ...
    nc4_out.project = "Fram 2020, Dynamics of Floating ice"

    nc4_out.instrument = "GNSS, IMU, waves in ice"

    nc4_out.references = "https://fram2020.no/weekly "
