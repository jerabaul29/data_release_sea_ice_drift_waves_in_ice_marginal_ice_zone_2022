...
time_start = datetime(year=2020, month=7, day=13, hour=00, tzinfo=None)  # the beginning of the cruise
time_end = datetime(year=2020, month=9, day=25, hour=23, tzinfo=None)  # long enough later that all stopped to work
