...
(note: these specific commands correspond to the 2020 data, so you will need to adjust key values for the instruments names, and the output will have different values, but the commands should be similar).
