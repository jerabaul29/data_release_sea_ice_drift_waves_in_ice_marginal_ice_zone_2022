...
time_start = datetime(year=2020, month=3, day=14, hour=00, tzinfo=None)  # the beginning of the cruise
time_end = datetime(year=2020, month=3, day=28, hour=23, tzinfo=None)  # long enough later that all stopped to work
    ...
    if crrt_time > time_start and crrt_time < time_end:
        ...
        if dict_data[crrt_key]['data_kind'] == 'status':
            ...
            try:
                ...
                dict_data_each_logger[crrt_logger_ID]["VBat"].append(math.nan)
    else:
