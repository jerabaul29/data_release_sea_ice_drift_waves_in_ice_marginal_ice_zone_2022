...
output_file = "data_landfast_waves_Gronfjorden_2020_03.nc"
...
with nc4.Dataset(output_file, "w", format="NETCDF4") as nc4_out:
    ...
    nc4_out.title = "Wave measurements from the Gronfjorden 2020 deployment in the XX project"

    nc4_out.summary = \
        "The wave measurements in landfast ice from the XX:project. The " +\
        "wave measurements were obtained by instruments deployed on the landfast ice. For more information " +\
        "about the deployment, see: XX:publication_or_report. " +\
        "The data are created, stored, and quality checked using the code available at: " +\
        "https://github.com/jerabaul29/data_release_sea_ice_drift_waves_in_ice_marginal_ice_zone_2022/tree/master/Data/2020_March_SvalbardGronfjorden . " +\
    ...
    nc4_out.date_created = "2021-09-05T12:00:00:Z"
    nc4_out.creator_type = "person"
    nc4_out.creator_institution = "XX:modify_to_UoM? Norwegian Meteorological Institute (MET)"
    nc4_out.creator_name = "XX:keep_only_Joey? Joey Voermans Jean Rabault"
    nc4_out.creator_email = "XX:email_address_Joey? jeanr@met.no"
    nc4_out.creator_url = "XX:doi_Joey? https://orcid.org/0000-0002-7244-6592"
    nc4_out.institution = "XX:UoM_only? University of Melbourne Norwegian Meteorological Institute (MET)"
    nc4_out.project = "XX:project_of_UoM Arven etter Nansen, Nansen Legacy Project, Dynamics of Floating ice"

    nc4_out.instrument = "GNSS, IMU, waves in ice"

    nc4_out.references = "XX:link_to_paper https://doi.org/10.7557/nlrs.5503 "

    nc4_out.license = "CC-BY-4.0"

    nc4_out.publisher_type = "institution"
    nc4_out.publisher_name = "XX:UoM_and_Met? University of Melbourne Norwegian Meteorological Institute"
    nc4_out.publisher_url = "XX:put_both_urls? met.no"
    nc4_out.publisher_email = "XX:put_both_emails? post@met.no"
