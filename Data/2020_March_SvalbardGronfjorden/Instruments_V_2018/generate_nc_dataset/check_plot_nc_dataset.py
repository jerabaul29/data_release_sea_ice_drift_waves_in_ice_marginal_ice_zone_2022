...
input_file = "./data_landfast_waves_Gronfjorden_2020_03.nc"
...
for crrt_index, crrt_instrument_id in enumerate(list_keys_ordered_by_first_lat):
    ...
    plt.plot(crrt_list_lon[:-1], crrt_list_lat[:-1], label="{}".format(crrt_instrument_id), marker="*", color=list_colors[crrt_index])
...
for crrt_index, crrt_logger_ID in enumerate(list_keys_ordered_by_first_lat):
    ...
    pclr = plt.pcolor(crrt_datetimes_holed[1:-1], frequencies, np.transpose(crrt_spectra_logged_holed)[:, 1:-1], vmin=-4.0, vmax=-1.5)
...
for crrt_index, crrt_key in enumerate(list_keys_ordered_by_first_lat):
    ...
    if crrt_index == len(list_keys_ordered_by_first_lat)-1:
        ax1.plot(crrt_list_datetimes[:-1], crrt_list_SWH[:-1], color=crrt_color, linestyle="--", marker="+", label="SWH {}".format(crrt_key))
        ax1.plot(crrt_list_datetimes[:-1], crrt_list_Hs[:-1], color=crrt_color, linestyle="-.", marker="*", label="Hs")
        ax1.plot(crrt_list_datetimes[:-1], crrt_list_Hs_proc[:-1], color=crrt_color, linestyle=":", marker="o", label="Hs_proc")
        ...
        ax1.plot(crrt_list_datetimes[:-1], crrt_list_SWH[:-1], color=crrt_color, linestyle="--", marker="+", label="SWH {}".format(crrt_key))
        ax1.plot(crrt_list_datetimes[:-1], crrt_list_Hs[:-1], color=crrt_color, linestyle="-.", marker="*")
        ax1.plot(crrt_list_datetimes[:-1], crrt_list_Hs_proc[:-1], color=crrt_color, linestyle=":", marker="o")

    # plot on the bottom subplot: wave period properties
    # is it time to set the axis, legend, etc, properties?
    if crrt_index == len(list_keys_ordered_by_first_lat)-1:
        ax2.plot(crrt_list_datetimes[:-1], crrt_list_Tp[:-1], color=crrt_color, linestyle="--", marker="+", label="Tp {}".format(crrt_key))
        ax2.plot(crrt_list_datetimes[:-1], crrt_list_Tz0[:-1], color=crrt_color, linestyle="-.", marker="*", label="Tz0")
        ax2.plot(crrt_list_datetimes[:-1], crrt_list_Tz0_proc[:-1], color=crrt_color, linestyle=":", marker="o", label="Tz0_proc")
        ...
        ax2.plot(crrt_list_datetimes[:-1], crrt_list_Tp[:-1], color=crrt_color, linestyle="--", marker="+", label="Tp {}".format(crrt_key))
        ax2.plot(crrt_list_datetimes[:-1], crrt_list_Tz0[:-1], color=crrt_color, linestyle="-.", marker="*")
        ax2.plot(crrt_list_datetimes[:-1], crrt_list_Tz0_proc[:-1], color=crrt_color, linestyle=":", marker="o")
