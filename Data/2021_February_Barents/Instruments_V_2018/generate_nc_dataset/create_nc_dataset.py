...
output_file = "data_drift_waves_Barents_2021_02.nc"
...
with nc4.Dataset(output_file, "w", format="NETCDF4") as nc4_out:
    ...
    nc4_out.title = "Sea ice drift and wave measurements from the Nansen Legacy Cruise PC-2: Winter Process Cruise (WPC), 2021"
    ...
    nc4_out.summary = \
        ...
        "https://github.com/jerabaul29/data_release_sea_ice_drift_waves_in_ice_marginal_ice_zone_2022/tree/master/Data/2021_February_Barents/Instruments_V_2018 . " +\
